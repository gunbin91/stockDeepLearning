...
chcp 65001 > nul
REM ============================================================================
REM Batch Script for Cleaning Up LightGBM Preprocessed Data (WSL Execution)
REM ============================================================================
REM This script cleans up only preprocessed data, NOT trained models.
REM Trained models (lgbm_model.txt, etc.) are NOT deleted.

echo.
echo Cleaning up LightGBM preprocessed data in WSL environment...
echo.
...
set "SCRIPT_PATH=%~dp0sh\cleanup_lgbm_data.sh"
