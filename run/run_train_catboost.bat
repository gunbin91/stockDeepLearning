...
chcp 65001 > nul
REM ============================================================================
REM CatBoost Model Training Batch Script (WSL Execution)
REM ============================================================================
REM This script uses WSL (Windows Subsystem for Linux) to run
REM the CatBoost training pipeline.

REM --- WSL Execution ---
echo.
echo Starting CatBoost training via WSL... (Logs will be displayed in this window)
echo.

REM Set the path to the shell script inside WSL
set "SCRIPT_PATH=%~dp0sh\train_catboost.sh"
